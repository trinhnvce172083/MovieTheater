...
('POINTS100', 'Đổi điểm ưu đãi', 'Đổi 100 điểm để giảm 30,000 VNĐ', 'POINTS', 30000,
 ...
 100, 24, TRUE,
 NOW(), NOW(), 'SYSTEM');
-- Points Promotion 1: 50 points for 15,000 VND discount
INSERT INTO promotion (code,
                       name,
                       description,
                       type,
                       discount_amount,
...
VALUES ('POINTS50',
        'Đổi điểm ưu đãi 50',
        'Đổi 50 điểm để giảm 15,000 VNĐ',
        'POINTS',
        15000,
        15000,
        30000,
        ...
        3,
        TRUE,
        'https://cuzwjjseeohnyrbfcngs.supabase.co/storage/v1/object/public/image/promotions/banners/in-voucher-02.jpg',
        50,
        24,
        TRUE,
        NOW(),
...
-- Points Promotion 2: 200 points for 60,000 VND discount
INSERT INTO promotion (code,
                       name,
                       description,
                       type,
...
VALUES ('POINTS200',
        'Đổi điểm ưu đãi 200',
        'Đổi 200 điểm để giảm 60,000 VNĐ',
        'POINTS',
        60000,
        60000,
        100000,
...
-- Points Promotion 3: 300 points for 90,000 VND discount
INSERT INTO promotion (code,
                       name,
                       description,
                       type,
...
VALUES ('POINTS300',
        'Đổi điểm ưu đãi 300',
        'Đổi 300 điểm để giảm 90,000 VNĐ',
        'POINTS',
        90000,
        90000,
        150000,
...
-- Points Promotion 4: 500 points for 150,000 VND discount
INSERT INTO promotion (code,
                       name,
                       description,
                       type,
...
VALUES ('POINTS500',
        'Đổi điểm ưu đãi 500',
        'Đổi 500 điểm để giảm 150,000 VNĐ',
        'POINTS',
        150000,
        150000,
        250000,
