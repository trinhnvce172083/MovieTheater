      ...
      <div className="text-center">
        ...
        <div className="mt-6 max-w-md mx-auto">
          <div className="bg-gray-800 rounded-full h-2 overflow-hidden">
            <div
              className="bg-gradient-to-r from-orange-500 to-orange-600 h-full rounded-full animate-pulse"
              style={{ width: "70%" }}
            ></div>
          </div>
      ...
      <div className="text-center">
        <div className="bg-black/30 backdrop-blur-sm rounded-lg p-4 border border-orange-500/20 inline-block">
          ...
          <p className="text-gray-300 text-sm max-w-md">
            Our API loads fresh movie data in real-time, ensuring you always see
            the latest showtimes and availability.
          </p>
        </div>
      </div>
    </div>
