...
public class LoyaltyPointsResponse {
    ...
    public String getMembershipLevelDisplay() {
        switch (membershipLevel) {
            ...
            default: return membershipLevel;
        }
    }
    ...
    public Integer getPointsToNextLevel() {
        switch (membershipLevel) {
            case "BRONZE": return 2000 - currentPoints;
            case "SILVER": return 5000 - currentPoints;
            case "GOLD": return 10000 - currentPoints;
            case "PLATINUM": return 0; // Already at highest level
            default: return 0;
        }
    }
    ...
    public String getNextMembershipLevel() {
        switch (membershipLevel) {
            ...
            case "PLATINUM": return "PLATINUM"; // Already at highest level
