...
/**
 * Now Showing Movie Filter Request DTO
 * Data Transfer Object for filtering currently showing movies
 * 
 * @author Dũng_Solo
 * @version 1.0.0
 */
...
@NoArgsConstructor
@AllArgsConstructor
public class NowShowingFilterRequest {
    ...
    // Special filters for now showing
    private Boolean availableToday; // Has schedules today
    private Boolean hasAvailableSeats; // Has available seats for booking
    private String cinemaLocation; // Filter by cinema location
    ...
    public MovieFilterRequest toMovieFilterRequest() {
        ...
        request.setStatus("NOW_SHOWING"); // Force status to NOW_SHOWING
        ...
        request.setAvailableToday(this.availableToday);
