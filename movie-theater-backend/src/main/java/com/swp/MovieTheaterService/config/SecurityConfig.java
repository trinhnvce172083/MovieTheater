    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        // Theo SRS: Customer có thể xem movie list, promotions, ticket prices, showtimes
                        .requestMatchers(
                        ...
                        .requestMatchers(
                                ...
                                "/api/employees/ticket-selling/**", // Selling management
                                
                                // Ticket Booking Management (SRS 3.1.6)  
                                "/api/staff/ticket-booking/**",    // Booking management
                                "/api/employees/booking-management/**", // Booking operations
                        ...
                        // =================== MEMBER ENDPOINTS ===================
                        // Theo SRS: Member có tất cả quyền Customer + booking, account management
                        .requestMatchers(
