...
public interface SeatReservationService {
    ...
    class SeatStatus {
        ...
        public String getReservedBySession() {
            return reservedBySession;
        }

        public void setReservedBySession(String reservedBySession) {
            this.reservedBySession = reservedBySession;
        }
