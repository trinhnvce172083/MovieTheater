...
import com.swp.MovieTheaterService.dto.movie.*;
...
public interface MovieService {
    ...
    class MovieStatistics {
        ...
        public Long getNowShowingCount() {
            return nowShowingCount;
        }

        public void setNowShowingCount(Long nowShowingCount) {
            this.nowShowingCount = nowShowingCount;
        }

        public Long getComingSoonCount() {
            return comingSoonCount;
        }

        public void setComingSoonCount(Long comingSoonCount) {
            this.comingSoonCount = comingSoonCount;
        }
        ...
        public void setFeaturedCount(Long featuredCount) {
            this.featuredCount = featuredCount;
        }
