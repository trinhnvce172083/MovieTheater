...
public interface CinemaRoomService {
    ...
    class CinemaRoomStatistics {
        ...
        public Long getStandardRooms() {
            return standardRooms;
        }

        public void setStandardRooms(Long standardRooms) {
            this.standardRooms = standardRooms;
        }
        ...
        public void setVipRooms(Long vipRooms) {
            this.vipRooms = vipRooms;
        }

        public Long getImaxRooms() {
            return imaxRooms;
        }

        public void setImaxRooms(Long imaxRooms) {
            this.imaxRooms = imaxRooms;
        }

        public Long getFourDXRooms() {
            return fourDXRooms;
        }

        public void setFourDXRooms(Long fourDXRooms) {
            this.fourDXRooms = fourDXRooms;
        }
        ...
        public Long getRooms3D() {
            return rooms3D;
        }

        public void setRooms3D(Long rooms3D) {
            this.rooms3D = rooms3D;
        }

        public Long getRoomsDolbyAtmos() {
            return roomsDolbyAtmos;
        }

        public void setRoomsDolbyAtmos(Long roomsDolbyAtmos) {
            this.roomsDolbyAtmos = roomsDolbyAtmos;
        }

        public Long getRoomsRecliner() {
            return roomsRecliner;
        }

        public void setRoomsRecliner(Long roomsRecliner) {
            this.roomsRecliner = roomsRecliner;
        }

        public Double getAveragePriceMultiplier() {
            return averagePriceMultiplier;
        }

        public void setAveragePriceMultiplier(Double averagePriceMultiplier) {
            this.averagePriceMultiplier = averagePriceMultiplier;
        }
    }
} 
