...
public interface ScheduleService {
    ...
    class ScheduleStatistics {
        ...
        public Long getTotalBookedSeats() {
            return totalBookedSeats;
        }

        public void setTotalBookedSeats(Long totalBookedSeats) {
            this.totalBookedSeats = totalBookedSeats;
        }
        ...
        public Long getSchedules3D() {
            return schedules3D;
        }

        public void setSchedules3D(Long schedules3D) {
            this.schedules3D = schedules3D;
        }

        public Long getSchedulesIMAX() {
            return schedulesIMAX;
        }

        public void setSchedulesIMAX(Long schedulesIMAX) {
            this.schedulesIMAX = schedulesIMAX;
        }

        public Long getSchedules4DX() {
            return schedules4DX;
        }

        public void setSchedules4DX(Long schedules4DX) {
            this.schedules4DX = schedules4DX;
        }
